...
public class UpgradeManager {
	...
	static {
		...
		temp = new Upgrade();
		temp.stack = new ItemStack(Items.apple);
	...
	private static IUpgrade getInstance(Class clazz) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException,
