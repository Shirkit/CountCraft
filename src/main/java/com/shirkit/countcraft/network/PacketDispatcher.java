...
public class PacketDispatcher {
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(ModInfos.ID);
	...
	public static final void registerPackets() {
		...
		PacketDispatcher.registerMessage(UpdateClientCounterMessage.Handler.class, UpdateClientCounterMessage.class, Side.CLIENT);
		PacketDispatcher.registerMessage(UpdateServerMessage.Handler.class, UpdateServerMessage.class, Side.SERVER);
