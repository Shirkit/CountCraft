...
public class BufferedRenderer extends TileEntitySpecialRenderer implements IItemRenderer {
	...
	public BufferedRenderer(float red, float green, float blue) {
		...
		this.green = green;
		this.blue = blue;
		block = CountCraft.instance.itemCounter;
	}
	...
	public void renderBufferedBlockCounter(ISyncCapable buffer, double par2, double par4, double par6, float par8) {
	...
	public void renderTileEntityAt(TileEntity buffer, double par2, double par4, double par6, float par8) {
		this.renderBufferedBlockCounter((ISyncCapable) buffer, par2, par4, par6, par8);
	}
